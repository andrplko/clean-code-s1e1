...
var createNewTaskElement = function (taskString) {
  ...
  listItem.classList.add("todo__item", "item");
  ...
  editButton.classList.add("item__button-edit", "button");

  //button.delete
  var deleteButton = document.createElement("button")//delete button
  deleteButton.classList.add("item__button-delete", "button");
...
var bindTaskEvents = function (taskListItem, checkBoxEventHandler) {
  ...
  var editButton = taskListItem.querySelector(".item__button-edit");
  var deleteButton = taskListItem.querySelector(".item__button-delete");
